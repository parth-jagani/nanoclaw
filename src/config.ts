...
// Docker container name for the OneCLI gateway itself (not an agent container).
// Used only for self-healing restarts when the gateway becomes unreachable —
// see recordOneCliOutcome in container-runner.ts.
export const ONECLI_CONTAINER_NAME = process.env.ONECLI_CONTAINER_NAME || envConfig.ONECLI_CONTAINER_NAME || 'onecli';
